        ...
        BrowseMyOwnedDocuments: $defineScreen(BrowseMyOwnedDocuments, [
            {
                ...
                createQuery: function (Search) {
                    return this.dataWorkspace.ApplicationData.MyOwnedDocuments().filter("(" + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", DocumentType/DocumentTypeCode)") + " or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", Reference)") + ") or " + ((Search === undefined || Search === null) ? "true" : "substringof(" + $toODataString(Search, "String?") + ", DocumentTitle)") + "").expand("DocumentType");
                }
            },
            { name: "Search", kind: "local", type: String }
        ], [
